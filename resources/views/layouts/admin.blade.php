...
<body class="flex h-screen bg-gray-100 overflow-hidden">
    ...
    <div class="bg-gray-900 text-white w-64 space-y-6 py-7 px-2 fixed inset-y-0 left-0 z-30">
        ...
        <nav class="mt-10 px-4">
            <a href="/admin" class="block py-2.5 px-4 rounded transition duration-200 @if(request()->is('admin')) bg-indigo-800 text-white @else hover:bg-gray-800 @endif">
                <i class="fas fa-home mr-2"></i>Dashboard
            </a>
            <a href="/admin/products" class="block py-2.5 px-4 rounded transition duration-200 @if(request()->is('admin/products*')) bg-indigo-800 text-white @else hover:bg-gray-800 @endif">
        ...
        <div class="px-4 mt-12">
            ...
            <div class="mt-4">
                ...
                <a href="/logout" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
